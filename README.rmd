...
This is quite similar to the climate lab's three colour gradient but they also tend to put white for average data. 
...
You may want to code missing data as white though in which case that could be deceptive take this plot from St Margaret's Bay, NS, Canada for example. There are missing data around 2012 which are coded white.
